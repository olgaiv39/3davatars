...
# # constants
basic_path=/root/3davatars/3DMM/files/;
resources_path=/root/3davatars/resources;

uv_base="/root/3davatars/3DMM/files/AI-NEXT-Albedo-Global.mat"
uv_regional_pyramid_base="/root/3davatars/3DMM/files/AI-NEXT-AlbedoNormal-RPB/"

if [ $is_bfm == "False" ];then
    shape_exp_bases="/root/3davatars/3DMM/files/AI-NEXT-Shape-NoAug.mat"
else
